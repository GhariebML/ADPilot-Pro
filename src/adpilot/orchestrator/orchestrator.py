...
class CampaignOrchestrator:
    ...
    def __init__(
        ...
        product_classifier_agent: Optional[ProductClassifierAgent] = None,
        ...
        self.product_classifier_agent = product_classifier_agent or ProductClassifierAgent()
    ...
    async def run(self, campaign_id: str, brief: CampaignInput) -> CampaignContext:
        ...
        # 0. Product Classifier Agent
        context = await self._execute_stage("product_classifier_agent", self.product_classifier_agent.run, campaign_id)
