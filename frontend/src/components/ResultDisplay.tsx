      ...
      <div className="flex items-center justify-between p-1">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3.5 py-2.5 bg-slate-900 hover:bg-slate-800 border border-slate-700 text-slate-200 rounded-xl text-xs font-mono font-bold flex items-center gap-2 transition-all active:scale-95"
          >
          ...
          <button
            ...
            className="px-4 py-2.5 bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 text-white rounded-xl text-xs font-bold font-mono flex items-center gap-2 transition-all active:scale-95 shadow-lg shadow-cyan-500/20"
          >
